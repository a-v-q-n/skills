...
`moment`), frontmatter des agents, absence de champ `version` où que ce soit, et **fraîcheur de
la zone générée du `README.md`**. Le second contrôle porte sur l'outil lui-même.
