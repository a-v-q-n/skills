---
name: repurposer
description: Tirer une série de vidéos en préproduction d'un enregistrement
  long — déposer le rush, lire son transcript, écrire le plan de série et le
  critiquer, puis poser chaque morceau : ses extraits cadrés et son intention. À
  charger dès que la demande porte sur un long form, un webinaire, un
  enregistrement d'écran ou une conférence à découper en plusieurs shorts.
---
